...
[_LOWER] = LAYOUT_ortho_5x12(
    ...
    KC_DEL,  KC_LBRC, KC_LCBR, KC_RCBR, KC_RBRC,  _______, _______, KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, KC_PIPE,
    _______, _______, _______, _______, _______,  _______, _______, KC_INS,  KC_HOME, KC_END,  KC_MS_U, KC_BTN2,
...
[_RAISE] = LAYOUT_ortho_5x12(
    ...
    _______, _______, _______, _______, _______, _______, _______, _______, QK_BOOT, KC_MPRV, KC_VOLD, KC_MNXT
),
